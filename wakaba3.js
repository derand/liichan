...
function showPostPreview(e) {
	...
	else AJAX(brd, tNum, function(err) {functor(cln, err || ajaxPosts[tNum][pNum] || 'ааОбб аНаЕ аНаАаЙаДаЕаН')})}
...
// KILL IT WITH FIRE! 
//function addcss(mycss){var h=document.getElementsByTagName("head");var nSS=document.createElement("style"); nSS.type="text/css"; h[0].appendChild(nSS); try{ nSS.styleSheet.cssText=mycss; }catch(e){try{nSS.appendChild(document.createTextNode(mycss)); nSS.innerHTML=mycss; }catch(e){}}}; 
// addcss('blockquote {\nmax-height: 400px;\noverflow: auto;\n}'); 
